...
class MiniPlayer(QtWidgets.QMainWindow):
    ...
    def open_file(self):
        ...
        testurl = "https://www.youtube.com/watch?v=MGGMszebZHU"
        video = pafy.new(testurl)
        best = video.getbest()
        self.media = self.instance.media_new(best.url)
        
        # infinite loop
        self.videolength = video.length
        ...
        self.setWindowTitle(video._title)
